<template>
    <div class="">
        ...
        <p>The image will "stick" to the screen when you reach its
            scroll position.</p>
        <img class="sticky" src="https://www.w3schools.com/howto/img_avatar.png" alt="Avatar">
        <h2>Scroll Down</h2>
        <p>Some example text..</p>
        <p><b>Scroll back up again to "remove" the sticky
                position.</b></p>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
            ...
            porta. Cras ac leo purus. Mauris quis diam velit. Lorem
