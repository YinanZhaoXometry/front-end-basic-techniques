...
export default {
    ...
    created() {},
    mounted() {
        this.w3CodeColor(document.getElementById('myDiv'))
    },
    methods: {
        w3CodeColor(elmnt, mode) {
            var lang = mode || 'html'
            ...
            function htmlMode(txt) {
                ...
                while (rest.indexOf('&lt;') > -1) {
                    ...
                    if (
                        rest.substr(startpos, 10).toUpperCase() == '&LT;SCRIPT'
                    ) {
                        note = 'javascript'
                    }
